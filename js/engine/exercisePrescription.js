...
const ExerciseRx = {
  ...
  // ---- 7. 中国《全民健身指南》官方标准（国家体育总局2017）----
  chinaGuidelines: {
    intensity: [
      { level: '小强度', heartRate: '≤100次/分', met: '<3.0', example: '散步、家务' },
      { level: '中等强度', heartRate: '100-140次/分', met: '3.0-5.9', example: '健步走、慢跑、骑车12-16km/h、太极拳、网球双打' },
      { level: '大强度', heartRate: '≥140次/分', met: '≥6.0', example: '跑步8km/h+、快骑16km/h+、快速爬山、登楼梯、网球单打' },
    ],
    weekly: {
      frequency: '每周3-7天',
      dailyDuration: '每天30-90分钟（每次至少10分钟）',
      moderate: '中等强度每周累计150-300分钟',
      vigorous: '大强度每周累计75分钟以上',
      optimal: '最优效果：每周300分钟中等或150分钟大强度',
      strength: '每周2-3次力量练习',
      stretch: '每周不少于5次牵拉练习',
    },
    phased: [
      { phase: '初期（前8周）', intensity: '有氧强度60-65%最大心率', freq: '每周3天起步' },
      { phase: '中期（8周后）', intensity: '逐步增至70-80%最大心率', freq: '中等强度达每周150分钟以上' },
      { phase: '长期稳定', intensity: '保持运动5-7天/周', note: '大强度每周不超过3次' },
    ],
    structure: '完整健身流程：准备活动5-10分钟 → 基本活动（有氧/力量/球类/传统运动）→ 放松活动5-10分钟',
    dailyActivity: '每天主动身体活动6000步，减少久坐每小时起身活动',
  },

  // ---- 8. ACSM FITT-VP 第十一版标准 ----
  acsmPrescription: {
    aerobic: {
      freq: '每周3-5天中等强度，或至少3天大强度',
      intensity: '中等强度60-70%HRmax(RPE12-13)；较大强度70-85%HRmax(RPE14-17)',
      time: '每次20-60分钟连续或间歇',
      type: '大肌群节律性有氧（快走/慢跑/游泳/骑车）',
      volume: '每周≥150分钟中等或≥75分钟大强度，或500-1000 MET-min/周',
      progression: '初期适应4-6周，之后每2-3周逐步增加时间/强度/频率',
      hiit: 'HIIT正式纳入有氧处方选项',
    },
    resistance: {
      freq: '每个大肌群每周2-3天',
      intensity: '初学者60-70%1RM；有经验者80%1RM+；老年人/久坐40-50%1RM起步',
      sets: '提高力量2-4组；初学者/老年人1组也有效；耐力≤2组',
      reps: '力量和爆发力8-12次/组；老年人/初学者10-15次/组；耐力15-20次/组',
      type: '多关节复合动作（深蹲/卧推/划船）为主，辅以单关节',
      rest: '组间休息2-3分钟，同肌群训练间隔至少48小时',
    },
    flexibility: {
      freq: '每周2-3天以上，最好每天',
      intensity: '拉伸至有牵拉感但不痛',
