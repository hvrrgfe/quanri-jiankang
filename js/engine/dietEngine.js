...
- 鱼虾 ≥2次`;
  ...
  getSeasonalIngredients() {
    ...
    const monthly = {
      1:  { veg: ['白菜','萝卜','菠菜','冬笋','菜薹','山药','莲藕','芋头'], fruit: ['橙子','橘子','猕猴桃','甘蔗'] },
      2:  { veg: ['白菜','菠菜','冬笋','菜薹','芹菜','韭菜','蒜苗'], fruit: ['橙子','草莓','甘蔗','猕猴桃'] },
      3:  { veg: ['韭菜','菠菜','春笋','豆苗','荠菜','香椿','芹菜','蒜苗'], fruit: ['草莓','菠萝','桑葚'] },
      4:  { veg: ['韭菜','菠菜','春笋','豆苗','荠菜','香椿','芦笋','豌豆'], fruit: ['草莓','菠萝','樱桃','桑葚'] },
      5:  { veg: ['黄瓜','番茄','茄子','四季豆','空心菜','豆角','芦笋','蒜苗'], fruit: ['樱桃','荔枝','芒果','菠萝'] },
      6:  { veg: ['黄瓜','番茄','茄子','苦瓜','丝瓜','空心菜','豆角','冬瓜','青椒'], fruit: ['西瓜','荔枝','桃子','芒果','葡萄'] },
      7:  { veg: ['黄瓜','番茄','茄子','苦瓜','丝瓜','空心菜','豆角','冬瓜','青椒','秋葵','苋菜'], fruit: ['西瓜','桃子','葡萄','荔枝','哈密瓜'] },
      8:  { veg: ['黄瓜','番茄','茄子','苦瓜','丝瓜','空心菜','冬瓜','青椒','秋葵','苋菜','茼蒿'], fruit: ['西瓜','桃子','葡萄','哈密瓜'] },
      9:  { veg: ['莲藕','山药','南瓜','白菜','萝卜','芋头','秋葵','茭白','空心菜'], fruit: ['梨','葡萄','石榴','苹果','柚子','枣'] },
      10: { veg: ['莲藕','山药','南瓜','白菜','萝卜','芋头','茭白','秋葵'], fruit: ['梨','柿子','石榴','苹果','柚子','枣'] },
      11: { veg: ['莲藕','山药','南瓜','白菜','萝卜','芋头','冬笋','菠菜'], fruit: ['梨','苹果','柚子','橙子','橘子'] },
      12: { veg: ['白菜','萝卜','菠菜','冬笋','菜薹','山药','莲藕','芋头'], fruit: ['橙子','橘子','猕猴桃','甘蔗','苹果'] },
    };
    const seasonNames = ['冬','冬','春','春','春','夏','夏','夏','秋','秋','秋','冬'];
    const data = monthly[month] || monthly[1];
    return { season: seasonNames[month-1], vegetables: data.veg, fruits: data.fruit, month };
  },
