...
## 每日各类食物推荐量
- 谷薯类：${daily.targets.grain}g
- 蔬菜：${daily.targets.vegetable}g（深色蔬菜至少占一半）
- 水果：${daily.targets.fruit}g
- 肉蛋类：${daily.targets.meatEgg}g
- 水产类：${daily.targets.seafood}g
...
3. ✅ 红肉（猪牛羊肉）每周总量 ≤500g
4. ✅ 鱼虾类 ≥2次/周
5. ✅ 控盐 ≤5g/天，控油 ≤25-30g/天
6. ✅ 三餐能量比例：早30%、午40%、晚30%
7. ✅ 一周内菜品尽量不重复
8. ✅ 每餐要有主食+蔬菜+蛋白质来源
9. ✅ 忌口和过敏食物绝对不能出现
10. ✅ 符合用户的口味偏好
  ...
  getDietGuidelineKnowledge() {
    return {
      ...
      guidelines: [
        {
          rule: '准则一 食物多样，合理搭配',
          details: '每日摄入≥12种食物，每周≥25种。主食包括谷类、薯类和杂豆。每天谷类200-300g，其中全谷物和杂豆50-150g；薯类50-100g。',
        },
        {
          rule: '准则二 吃动平衡，健康体重',
          details: '各年龄段都应天天进行身体活动。食不过量，保持能量平衡。每周至少5天中等强度运动，累计150分钟以上。',
        },
        {
          rule: '准则三 多吃蔬果、奶豆、大豆',
          details: '蔬菜300-500g/天，深色蔬菜占一半；水果200-350g/天；奶制品300ml/天；大豆20-30g/天；坚果适量。',
        },
        {
          rule: '准则四 适量吃鱼、禽、蛋、瘦肉',
          details: '鱼虾类40-75g/天，禽肉40-75g/天，蛋类1个/天。优先选择鱼和禽。红肉（猪牛羊）每周≤500g。',
        },
        {
          rule: '准则五 少盐少油，控糖限酒',
          details: '食盐≤5g/天，烹饪油≤25-30g/天。添加糖≤50g/天，最好≤25g。足量饮水，男性1700ml/天，女性1500ml/天。',
        },
        {
          rule: '准则六 规律进餐，足量饮水',
          details: '合理安排三餐，定时定量。早餐30%、午餐40%、晚餐30%。不暴饮暴食。',
        },
        {
          rule: '准则七 会烹会选，会看标签',
          details: '学会选择健康的食材和烹饪方式。阅读食品标签，选择低盐低脂低糖食品。多用蒸煮炖，少用煎炸。',
        },
        {
          rule: '准则八 公筷分餐，杜绝浪费',
          details: '讲究卫生，使用公筷。按需备餐，珍惜食物。',
        },
      ],
      foodPagoda: {
        level1: { name: '谷薯类', daily: '250-400g', note: '包括全谷物和杂豆50-150g，薯类50-100g' },
        level2: { name: '蔬菜水果', daily: '蔬菜300-500g，水果200-350g', note: '深色蔬菜应占1/2' },
        level3: { name: '肉蛋水产', daily: '肉蛋120-200g，水产40-75g', note: '优先鱼禽，红肉≤500g/周' },
        level4: { name: '奶豆坚果', daily: '奶类300ml，大豆20-30g，坚果10-15g', note: '乳糖不耐可选酸奶或低乳糖奶' },
        level5: { name: '油盐', daily: '油≤25-30g，盐≤5g', note: '培养清淡饮食习惯' },
      },
    };
  },
};
