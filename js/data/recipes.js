...
const RECIPES = {
  ...
  _buildRecipes() {
    return [
      ...
      // ===== 新增：深色蔬菜补充 =====
      { id: 'V12', name: '清炒芥蓝', category: '蔬菜素菜', mealType: 'dinner', difficulty: 1, cookTime: 8, prepTime: 3,
        ingredients: [{ name: '芥蓝', category: 'vegetable', amount: 250, unit: 'g' }, { name: '蒜', category: 'condiment', amount: 10, unit: 'g' }, { name: '姜', category: 'condiment', amount: 5, unit: 'g' }],
        nutrition: { calories: 55, protein: 3, fat: 1, carb: 6, fiber: 3, sodium: 120, vitC: 60, calcium: 80 },
        tags: ['快手', '清淡', '高钙'], tools: ['炒锅', '煮锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 1, oily: 1 },
        costPerServing: 4, season: ['冬', '春'], suitableFor: ['普通', '减脂'],
        steps: ['芥蓝去老皮切段', '焯水1分钟捞出', '爆香蒜末姜丝', '下芥蓝大火翻炒', '加盐和蚝油出锅'] },

      { id: 'V13', name: '蒜蓉苋菜', category: '蔬菜素菜', mealType: 'dinner', difficulty: 1, cookTime: 5, prepTime: 3,
        ingredients: [{ name: '苋菜', category: 'vegetable', amount: 250, unit: 'g' }, { name: '蒜', category: 'condiment', amount: 10, unit: 'g' }],
        nutrition: { calories: 40, protein: 3, fat: 1, carb: 5, fiber: 2, sodium: 100, iron: 3, calcium: 120 },
        tags: ['快手', '补铁', '清淡'], tools: ['炒锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 1, oily: 1 },
        costPerServing: 3, season: ['夏', '秋'], suitableFor: ['普通', '孕妇'],
        steps: ['苋菜去根洗净', '热油爆香蒜末', '下苋菜大火翻炒', '加盐调味', '炒至变软出锅'] },

      { id: 'V14', name: '清炒茼蒿', category: '蔬菜素菜', mealType: 'dinner', difficulty: 1, cookTime: 5, prepTime: 3,
        ingredients: [{ name: '茼蒿', category: 'vegetable', amount: 250, unit: 'g' }, { name: '蒜', category: 'condiment', amount: 8, unit: 'g' }],
        nutrition: { calories: 35, protein: 2, fat: 1, carb: 4, fiber: 2, sodium: 100, vitA: 80 },
        tags: ['快手', '清淡', '高纤维'], tools: ['炒锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 1, oily: 1 },
        costPerServing: 3, season: ['冬', '春'], suitableFor: ['普通', '减脂'],
        steps: ['茼蒿洗净切段', '热油爆香蒜末', '大火翻炒茼蒿1分钟', '加盐调味出锅'] },

      { id: 'V15', name: '蚝油秋葵', category: '蔬菜素菜', mealType: 'dinner', difficulty: 1, cookTime: 8, prepTime: 3,
        ingredients: [{ name: '秋葵', category: 'vegetable', amount: 200, unit: 'g' }, { name: '蒜', category: 'condiment', amount: 8, unit: 'g' }],
        nutrition: { calories: 45, protein: 2, fat: 1, carb: 7, fiber: 3, sodium: 200, folate: 60 },
        tags: ['快手', '清淡', '高纤维'], tools: ['煮锅', '炒锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 1 },
        costPerServing: 5, season: ['夏', '秋'], suitableFor: ['普通', '减脂', '孕妇'],
        steps: ['秋葵洗净去蒂', '焯水2分钟捞出', '调蚝油生抽蒜末汁', '浇在秋葵上'] },

      { id: 'V16', name: '上汤娃娃菜', category: '蔬菜素菜', mealType: 'lunch', difficulty: 1, cookTime: 10, prepTime: 3,
        ingredients: [{ name: '娃娃菜', category: 'vegetable', amount: 200, unit: 'g' }, { name: '皮蛋', category: 'egg', amount: 50, unit: 'g' }, { name: '火腿', category: 'meat', amount: 20, unit: 'g' }],
        nutrition: { calories: 90, protein: 8, fat: 5, carb: 5, fiber: 1.5, sodium: 400 },
        tags: ['清淡', '粤式', '快手'], tools: ['炒锅', '煮锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 1 },
        costPerServing: 6, season: ['全年'], suitableFor: ['普通', '老人'],
        steps: ['娃娃菜对半切开', '皮蛋火腿切丁', '炒香蒜末加高汤', '下娃娃菜煮3分钟', '加皮蛋火腿再煮2分钟', '加盐调味出锅'] },

      // ===== 新增：水产/海鲜补充 =====
      { id: 'F07', name: '清蒸鲈鱼', category: '午餐/晚餐·鱼虾', mealType: 'dinner', difficulty: 1, cookTime: 15, prepTime: 5,
        ingredients: [{ name: '鲈鱼', category: 'seafood', amount: 300, unit: 'g' }, { name: '葱', category: 'condiment', amount: 20, unit: 'g' }, { name: '姜', category: 'condiment', amount: 10, unit: 'g' }, { name: '蒸鱼豉油', category: 'condiment', amount: 15, unit: 'ml' }],
        nutrition: { calories: 220, protein: 35, fat: 8, carb: 2, fiber: 0, sodium: 350, omega3: 1.5 },
        tags: ['清淡', '高蛋白', '宴客'], tools: ['蒸锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 1 },
        costPerServing: 12, season: ['全年'], suitableFor: ['普通', '减脂', '老人', '儿童'],
        steps: ['鲈鱼处理干净两面划刀', '鱼身抹料酒塞姜片', '水开后蒸8分钟', '倒掉盘中蒸汁', '铺葱丝淋蒸鱼豉油', '浇热油激香'] },

      { id: 'F08', name: '香煎带鱼', category: '午餐/晚餐·鱼虾', mealType: 'dinner', difficulty: 2, cookTime: 15, prepTime: 8,
        ingredients: [{ name: '带鱼', category: 'seafood', amount: 250, unit: 'g' }, { name: '姜', category: 'condiment', amount: 10, unit: 'g' }],
        nutrition: { calories: 280, protein: 25, fat: 18, carb: 3, fiber: 0, sodium: 300, omega3: 2 },
        tags: ['下饭', '经典', '高蛋白'], tools: ['煎锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 3 },
        costPerServing: 10, season: ['全年'], suitableFor: ['普通'],
        steps: ['带鱼切段洗净加料酒姜腌制', '擦干水分裹薄淀粉', '油温六成下锅煎', '两面金黄后撒椒盐'] },

      { id: 'F09', name: '蒜蓉粉丝蒸虾', category: '午餐/晚餐·鱼虾', mealType: 'dinner', difficulty: 2, cookTime: 12, prepTime: 10,
        ingredients: [{ name: '虾', category: 'seafood', amount: 200, unit: 'g' }, { name: '粉丝', category: 'grain', amount: 50, unit: 'g' }, { name: '蒜', category: 'condiment', amount: 20, unit: 'g' }],
        nutrition: { calories: 200, protein: 22, fat: 6, carb: 15, fiber: 0.5, sodium: 350 },
        tags: ['宴客', '快手', '高蛋白'], tools: ['蒸锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 2 },
        costPerServing: 14, season: ['全年'], suitableFor: ['普通'],
        steps: ['粉丝泡软铺盘底', '虾开背去虾线摆在粉丝上', '蒜末炸至金黄铺在虾上', '水开后蒸6分钟', '淋蒸鱼豉油和热油'] },

      { id: 'F10', name: '蛤蜊蒸蛋', category: '午餐/晚餐·鱼虾', mealType: 'lunch', difficulty: 1, cookTime: 12, prepTime: 5,
        ingredients: [{ name: '蛤蜊', category: 'seafood', amount: 150, unit: 'g' }, { name: '鸡蛋', category: 'egg', amount: 100, unit: 'g' }, { name: '葱', category: 'condiment', amount: 5, unit: 'g' }],
        nutrition: { calories: 150, protein: 16, fat: 8, carb: 3, fiber: 0, sodium: 400, calcium: 80 },
        tags: ['清淡', '高蛋白', '儿童'], tools: ['蒸锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 1 },
        costPerServing: 8, season: ['全年'], suitableFor: ['普通', '儿童', '老人'],
        steps: ['蛤蜊吐沙后焯水至开口', '鸡蛋打散加温水搅匀', '摆好蛤蜊倒入蛋液', '水开后蒸8分钟', '淋生抽和香油'] },

      // ===== 新增：豆制品/杂粮补充 =====
      { id: 'T06', name: '香煎豆腐', category: '午餐/晚餐·猪肉', mealType: 'lunch', difficulty: 1, cookTime: 10, prepTime: 3,
        ingredients: [{ name: '老豆腐', category: 'tofu', amount: 200, unit: 'g' }, { name: '葱', category: 'condiment', amount: 10, unit: 'g' }],
        nutrition: { calories: 160, protein: 14, fat: 10, carb: 5, fiber: 1, sodium: 250, calcium: 150 },
        tags: ['快手', '素菜', '高钙'], tools: ['煎锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 2 },
        costPerServing: 3, season: ['全年'], suitableFor: ['普通', '减脂', '素食'],
        steps: ['豆腐切厚片擦干水分', '油热下锅煎至两面金黄', '淋生抽蚝油汁', '撒葱花出锅'] },

      { id: 'T07', name: '芹菜炒香干', category: '午餐/晚餐·猪肉', mealType: 'lunch', difficulty: 1, cookTime: 8, prepTime: 5,
        ingredients: [{ name: '香干', category: 'tofu', amount: 150, unit: 'g' }, { name: '芹菜', category: 'vegetable', amount: 150, unit: 'g' }, { name: '红椒', category: 'vegetable', amount: 30, unit: 'g' }],
        nutrition: { calories: 140, protein: 12, fat: 8, carb: 6, fiber: 2.5, sodium: 350, calcium: 120 },
        tags: ['快手', '素菜', '高纤维'], tools: ['炒锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 2 },
        costPerServing: 4, season: ['全年'], suitableFor: ['普通', '减脂'],
        steps: ['香干切条芹菜切段', '热油炒香干至微焦', '下芹菜大火翻炒', '加盐生抽调味', '翻炒均匀出锅'] },

      { id: 'T08', name: '腐竹炒木耳', category: '午餐/晚餐·猪肉', mealType: 'lunch', difficulty: 1, cookTime: 10, prepTime: 10,
        ingredients: [{ name: '腐竹', category: 'tofu', amount: 80, unit: 'g' }, { name: '木耳', category: 'vegetable', amount: 50, unit: 'g' }, { name: '胡萝卜', category: 'vegetable', amount: 50, unit: 'g' }],
        nutrition: { calories: 180, protein: 14, fat: 10, carb: 10, fiber: 3, sodium: 250, calcium: 100 },
        tags: ['素菜', '高蛋白', '家常'], tools: ['炒锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 2, oily: 2 },
        costPerServing: 4, season: ['全年'], suitableFor: ['普通', '素食'],
        steps: ['腐竹木耳提前泡发', '腐竹切段胡萝卜切片', '热油爆香蒜末', '下所有食材翻炒', '加蚝油和盐调味'] },

      { id: 'T09', name: '藜麦蔬菜沙拉', category: '午餐/晚餐·鸡肉', mealType: 'lunch', difficulty: 1, cookTime: 15, prepTime: 5,
        ingredients: [{ name: '藜麦', category: 'grain', amount: 50, unit: 'g' }, { name: '小番茄', category: 'vegetable', amount: 80, unit: 'g' }, { name: '黄瓜', category: 'vegetable', amount: 80, unit: 'g' }, { name: '紫甘蓝', category: 'vegetable', amount: 50, unit: 'g' }],
        nutrition: { calories: 200, protein: 8, fat: 6, carb: 30, fiber: 5, sodium: 100, vitC: 30 },
        tags: ['轻食', '减脂', '高纤维'], tools: ['煮锅'], taste: { spicy: 0, sour: 1, sweet: 1, salty: 1, oily: 1 },
        costPerServing: 6, season: ['夏', '秋'], suitableFor: ['减脂', '素食'],
        steps: ['藜麦加水煮15分钟沥干', '小番茄对半切', '黄瓜切丁紫甘蓝切丝', '所有食材混合', '加橄榄油柠檬汁盐拌匀'] },

      // ===== 新增：羊肉/根茎类 =====
      { id: 'N07', name: '葱爆羊肉', category: '午餐/晚餐·牛肉', mealType: 'dinner', difficulty: 2, cookTime: 10, prepTime: 10,
        ingredients: [{ name: '羊肉', category: 'meat', amount: 250, unit: 'g' }, { name: '大葱', category: 'vegetable', amount: 100, unit: 'g' }, { name: '姜', category: 'condiment', amount: 5, unit: 'g' }],
        nutrition: { calories: 320, protein: 28, fat: 22, carb: 4, fiber: 0.5, sodium: 350, iron: 3 },
        tags: ['下饭', '北方菜', '快手'], tools: ['炒锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 3, oily: 3 },
        costPerServing: 12, season: ['冬', '秋'], suitableFor: ['普通'],
        steps: ['羊肉切薄片加料酒生抽腌制', '大葱斜切成段', '热油大火爆炒羊肉至变色', '加大葱翻炒', '加盐孜然调味出锅'] },

      { id: 'V17', name: '清蒸南瓜', category: '蔬菜素菜', mealType: 'lunch', difficulty: 1, cookTime: 15, prepTime: 3,
        ingredients: [{ name: '南瓜', category: 'vegetable', amount: 300, unit: 'g' }, { name: '红枣', category: 'fruit', amount: 20, unit: 'g' }],
        nutrition: { calories: 90, protein: 2, fat: 0.5, carb: 20, fiber: 2, sodium: 5, vitA: 200 },
        tags: ['快手', '清淡', '甜品'], tools: ['蒸锅'], taste: { spicy: 0, sour: 0, sweet: 3, salty: 0, oily: 0 },
        costPerServing: 3, season: ['秋', '冬'], suitableFor: ['普通', '老人', '儿童', '减脂'],
        steps: ['南瓜去皮切块', '红枣洗净', '水开后蒸15分钟', '可直接吃或淋蜂蜜'] },

      { id: 'V18', name: '葱油芋艿', category: '蔬菜素菜', mealType: 'lunch', difficulty: 1, cookTime: 20, prepTime: 5,
        ingredients: [{ name: '芋艿', category: 'vegetable', amount: 250, unit: 'g' }, { name: '葱', category: 'condiment', amount: 15, unit: 'g' }],
        nutrition: { calories: 130, protein: 3, fat: 4, carb: 22, fiber: 2, sodium: 200, potassium: 300 },
        tags: ['清淡', '江南菜', '素食'], tools: ['蒸锅', '炒锅'], taste: { spicy: 0, sour: 0, sweet: 0, salty: 1, oily: 1 },
        costPerServing: 3, season: ['秋', '冬'], suitableFor: ['普通', '素食'],
        steps: ['芋艿洗净蒸20分钟', '去皮切块', '葱切末用油炸至焦黄', '芋艿加盐拌匀', '淋上葱油'] },

      // ===== 新增：早餐补充 =====
      { id: 'B19', name: '燕麦牛奶+坚果+香蕉', category: '早餐', mealType: 'breakfast', difficulty: 1, cookTime: 3, prepTime: 1,
        ingredients: [{ name: '燕麦', category: 'grain', amount: 40, unit: 'g' }, { name: '牛奶', category: 'dairy', amount: 200, unit: 'ml' }, { name: '香蕉', category: 'fruit', amount: 100, unit: 'g' }, { name: '核桃', category: 'fruit', amount: 15, unit: 'g' }],
        nutrition: { calories: 320, protein: 12, fat: 12, carb: 42, fiber: 5, sodium: 60, potassium: 400 },
        tags: ['快手', '早餐', '高纤维'], tools: ['微波炉'], taste: { spicy: 0, sour: 0, sweet: 3, salty: 0, oily: 0 },
        costPerServing: 5, season: ['全年'], suitableFor: ['普通', '减脂', '儿童'],
        steps: ['燕麦加牛奶微波炉加热2分钟', '香蕉切片', '核桃掰碎', '撒在燕麦上即可'] },

      { id: 'B20', name: '红薯+白煮蛋+酸奶', category: '早餐', mealType: 'breakfast', difficulty: 1, cookTime: 15, prepTime: 1,
        ingredients: [{ name: '红薯', category: 'grain', amount: 150, unit: 'g' }, { name: '鸡蛋', category: 'egg', amount: 50, unit: 'g' }, { name: '酸奶', category: 'dairy', amount: 150, unit: 'g' }],
        nutrition: { calories: 300, protein: 16, fat: 6, carb: 45, fiber: 4, sodium: 100, calcium: 150 },
