...
const ExerciseDB = {
  ...
  getKnowledgeBase() {
    return {
      ...
      // 2025年《中国超重和肥胖人群运动处方指南》（中国体育科学学会+中国营养学会）
      china_obesity_2025: "超重肥胖处方2025（414项RCT/40条推荐）：有氧每周3-5次30-60min中等强度，总≥150min/周，降体重/BMI/腰围/体脂。有氧+抗阻每周3次（有氧≥75min+抗阻8-15次/组2-3组）额外提升肌力。HIIT每周3-5次15-30min效果相当",
      china_obesity_combined: "运动联合热量限制：在当前摄入减少约500千卡/天，联合运动减肥效果最优",
      china_obesity_comorbidity: "合并慢性病（T2DM/心血管病/代谢综合征/脂肪肝/PCOS）需个体化运动处方",

      // 2025-2026其他重要中国研究
      china_dose_response: "CHARLS研究3719人：最佳身体活动范围63.88-163.66MET-h/周（约4-12h中高强度活动），可最优改善血脂",
      china_rural_elderly: "农村老年人2026研究：身体活动总量比强度更重要。每日至少步行30分钟（含5分钟快走），72岁前达同龄人中位即获益",
      china_sarcopenia: "肌少症运动处方2026：抗阻+有氧每周≥90分钟，显著改善握力和身体功能",
      china_evidence_summary: "运动处方证据总结2026：8方面33条最佳证据——多学科团队、运动评估、FITT-VP原则、远程干预、依从性、安全性",
    };
  },
};
